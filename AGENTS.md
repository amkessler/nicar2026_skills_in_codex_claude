...
This repo is a lightweight Python/Jupyter project for FEC filing workflows and Codex skill demos.
...
- `.codex/skills/fecfile/`: repo-local `fecfile` skill used by Codex.
- `skills/`: additional example skills (weather, image-rotator, skill-creator).
