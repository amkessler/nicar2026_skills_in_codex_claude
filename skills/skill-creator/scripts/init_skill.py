...
### scripts/
Executable code (Python/Bash/R/etc.) that can be run directly to perform specific operations.

**Examples from other skills:**
- PDF skill: `fill_fillable_fields.py`, `extract_form_field_info.py` - utilities for PDF manipulation
- DOCX skill: `document.py`, `utilities.py` - Python modules for document processing

**Appropriate for:** Python scripts, R scripts, shell scripts, or any executable code that performs automation, data processing, or specific operations.
...
Keep the portable workflow in this `SKILL.md`. Add surface-specific metadata only when needed:

- Claude Code: frontmatter such as `disable-model-invocation`, `user-invocable`, `allowed-tools`, `disallowed-tools`, `argument-hint`, `arguments`, or `context`.
- Codex: optional `agents/openai.yaml` for UI metadata, implicit-invocation policy, and tool dependencies.
- Distribution beyond one repo: prefer a plugin package when bundling multiple skills, connectors, or MCP tools.
"""
