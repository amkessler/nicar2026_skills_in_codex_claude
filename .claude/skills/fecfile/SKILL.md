...
```bash
uv run --script skills/fecfile/scripts/fetch_filing.py <ID> --summary-only
```
...
```bash
uv run --script skills/fecfile/scripts/fetch_filing.py <ID> --stream --schedule A | python3 -c "
import sys
count = 0
limit = 256
...
uv run --script skills/fecfile/scripts/fetch_filing.py <ID> --schedule A 2>&1 | uv run /tmp/analysis.py
```
...
```bash
uv run --script skills/fecfile/scripts/fetch_filing.py <ID> --stream --schedule A
```
